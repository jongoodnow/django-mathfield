...
class APITestCase(TestCase):
    ...
    def test_get_math_latex_at_start(self):
    ...
    def test_get_math_escaped_dollars(self):
        self.assertEqual(api.get_math('\\$foo$x=\\$ 2$bar\\$'), {
            'raw': '\\$foo$x=\\$ 2$bar\\$',
